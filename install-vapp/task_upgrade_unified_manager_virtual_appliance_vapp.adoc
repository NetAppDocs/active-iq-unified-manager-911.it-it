...
[role="lead"]
È possibile aggiornare l'appliance virtuale Active IQ Unified Manager dalle release 9.9 o 9.10 alla 9.11.
...
+
link:concept_virtual_infrastructure_or_hardware_system_requirements.html["Requisiti dell'infrastruttura virtuale"]

+
link:reference_vmware_software_and_installation_requirements.html["Software VMware e requisiti di installazione"]
