...
[role="lead"]
È possibile eseguire l'aggiornamento da Unified Manager 9.9 o 9.10 a 9.11 scaricando ed eseguendo il file di installazione sulla piattaforma Linux.
...
* MySQL Community Edition viene aggiornato automaticamente durante l'aggiornamento di Unified Manager. Se la versione installata di MySQL sul sistema è precedente alla 8.0.28, il processo di aggiornamento di Unified Manager aggiorna automaticamente MySQL alla versione 8.0.28.
