...
* MySQL Community Edition versione 8.0.28 (dal repository MySQL).
* OpenJDK versione 11.0.14 (dal repository Red Hat Extra Enterprise Linux Server)
* Python 3.6.x
...
+
link:task_manually_configure_epel_repository.html["Configurazione manuale del repository EPEL"]
...
+
link:task_manually_configure_mysql_repository.html["Configurazione manuale del repository MySQL"]
